...
var promptCriteria = function() {
  ...
  var promptedLength = function() {
    // Prompt length, and keep prompting if a null response is given
    var length = "";
  ...
  var promptedUpperOrLower = function() {
    // keep prompting if a null response is given
    var caseType = "";
    while (caseType === "" || caseType === null) {
